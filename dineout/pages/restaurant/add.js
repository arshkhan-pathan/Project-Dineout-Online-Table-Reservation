...
const Add = () => {
  ...
  const onSubmit = async (values) => {
    ...
    formData.append('tag_list', values.tags.map(tag => tag.id));
    formData.append('types_list', values.types.map(type => type.id));
    formData.append('cuisines_list', values.cuisines.map(cuisine => cuisine.id));
    formData.append('unit_charge', values.unitCharge);
    formData.append('manager', 27);
                    ...
                    <Grid container rowSpacing={3} columnSpacing={3}>
                      ...
                      <Grid item xs={12} sm={6} md={4} lg={3}>
                        <Select
                          ...
                          onChange={(values) => setFieldValue('cuisines', values)}
                        ...
                        <Grid item xs={12} sm={6}>
                          ...
                          title="restaurant"
                            ...
                            handleDrop={(acceptedFiles) => {
                              ...
                              setFieldValue('restaurantImages', [...values.restaurantImages, ...newFiles]);
                            }}
                        ...
                        <Grid item xs={12} sm={6} md={6} lg={6}>
                          ...
                          title="menu"
                            ...
                            handleDrop={(acceptedFiles) => {
                              ...
                              setFieldValue('menuImages', [...values.menuImages, ...newFiles]);
                            }}
