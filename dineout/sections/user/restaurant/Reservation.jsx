...
const Reservation = () => {
    ...
    const onGuestDecrement = () => setGuests((prev) => prev === 0 ? prev : prev - 1);
    ...
    const disableDate = (date) => {
        ...
        return currentDate > oneMonthFromNow || (currentDate < today && !isSameDate(currentDate, today));
    };
            ...
            <StyledContent>
                ...
                {selectedDate && (
                    <Box>
                        ...
                        <Box sx={{ gap: '3px', padding: 1, bgcolor: "#dbdbdbfa", borderRadius: 1, padding: "5px 15px", display: "flex", alignItems: 'center' }}>
                            ...
                            <Box sx={{display: 'flex', alignItems: 'center', gap: '5px'}}>
                                ...
                                <Typography variant="body2" fontWeight="bold">{guests}</Typography>
                ...
                <Grid container spacing={1}>
                    {timeSlots?.length > 0 &&
                        timeSlots.map((item, index) => (
                            <Grid item xs={4}>
                                <Chip
                                    sx={{ borderRadius: 1, width: '100%', height: '100%', paddingBlock: '13px' }}
                                    key={index}
                                    label={item[0][0]}
                                    clickable
